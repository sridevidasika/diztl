...
public final class DiztilServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<io.github.gravetii.generated.DiztilPojo.SearchRequest,
    ...
    if ((getSearchMethod = DiztilServiceGrpc.getSearchMethod) == null) {
      synchronized (DiztilServiceGrpc.class) {
        if ((getSearchMethod = DiztilServiceGrpc.getSearchMethod) == null) {
          DiztilServiceGrpc.getSearchMethod = getSearchMethod = 
  ...
  private static volatile io.grpc.MethodDescriptor<io.github.gravetii.generated.DiztilPojo.DownloadRequest,
      io.github.gravetii.generated.DiztilPojo.File> getUploadMethod;
  ...
  public static io.grpc.MethodDescriptor<io.github.gravetii.generated.DiztilPojo.DownloadRequest,
      io.github.gravetii.generated.DiztilPojo.File> getUploadMethod() {
    io.grpc.MethodDescriptor<io.github.gravetii.generated.DiztilPojo.DownloadRequest, io.github.gravetii.generated.DiztilPojo.File> getUploadMethod;
    if ((getUploadMethod = DiztilServiceGrpc.getUploadMethod) == null) {
      synchronized (DiztilServiceGrpc.class) {
        if ((getUploadMethod = DiztilServiceGrpc.getUploadMethod) == null) {
          DiztilServiceGrpc.getUploadMethod = getUploadMethod = 
              io.grpc.MethodDescriptor.<io.github.gravetii.generated.DiztilPojo.DownloadRequest, io.github.gravetii.generated.DiztilPojo.File>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "io.github.gravetii.generated.DiztilService", "upload"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.github.gravetii.generated.DiztilPojo.DownloadRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
   ...
   */
  public static DiztilServiceBlockingStub newBlockingStub(
   ...
   */
  public static DiztilServiceFutureStub newFutureStub(
      io.grpc.Channel channel) {
  ...
  /**
   */
  public static abstract class DiztilServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void upload(io.github.gravetii.generated.DiztilPojo.DownloadRequest request,
        io.grpc.stub.StreamObserver<io.github.gravetii.generated.DiztilPojo.File> responseObserver) {
  ...
  public static final class DiztilServiceStub extends io.grpc.stub.AbstractStub<DiztilServiceStub> {
    ...
    @java.lang.Override
    protected DiztilServiceStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
  ...
  /**
   */
  public static final class DiztilServiceBlockingStub extends io.grpc.stub.AbstractStub<DiztilServiceBlockingStub> {
    ...
    @java.lang.Override
    protected DiztilServiceBlockingStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
    ...
    /**
     */
    public io.github.gravetii.generated.DiztilPojo.SearchResponse search(io.github.gravetii.generated.DiztilPojo.SearchRequest request) {
  ...
  /**
   */
  public static final class DiztilServiceFutureStub extends io.grpc.stub.AbstractStub<DiztilServiceFutureStub> {
    ...
    @java.lang.Override
    protected DiztilServiceFutureStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.github.gravetii.generated.DiztilPojo.SearchResponse> search(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_UPLOAD:
          serviceImpl.upload((io.github.gravetii.generated.DiztilPojo.DownloadRequest) request,
              (io.grpc.stub.StreamObserver<io.github.gravetii.generated.DiztilPojo.File>) responseObserver);
          break;
        default:
  ...
  private static abstract class DiztilServiceBaseDescriptorSupplier
